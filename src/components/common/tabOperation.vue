<template>
  <el-tabs v-model="activeName" @tab-click="handleClick">
    <el-tab-pane label="点餐" name="first">
      ...
      <div class="btns">
        <el-button type="warning" size="small" @click="billstate" plain>挂单</el-button>
        <el-button type="danger" size="small" @click="billdelete" plain>删除</el-button>
        <el-button type="success" size="small" @click="billend" plain>结账</el-button>
      </div>
    </el-tab-pane>
